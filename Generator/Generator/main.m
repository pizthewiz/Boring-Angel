...
NSDictionary* emojiMap() {
    // via NSString-Emoji https://github.com/valeriomazzeo/NSString-Emoji/blob/master/NSString%2BEmoji.m
    return @{
        @":smile:": @"😄",
        @":laughing:": @"😆",
        @":blush:": @"😊",
