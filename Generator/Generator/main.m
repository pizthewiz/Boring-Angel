...
// https://github.com/diy/NSStringEmojize/blob/master/NSStringEmojize/NSString%2BEmojize.m
...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        [uniqueEmoji enumerateObjectsUsingBlock:^(NSString* emoji, BOOL *stop) {
            NSString* code = [[emojiAliases() allKeysForObject:emoji][0] stringByReplacingOccurrencesOfString:@":" withString:@""];
